...
export function AIFeature() {
  const ontologyRules = [
    { name: 'SLA Tiers', desc: 'Auto-adjusts priority based on contract.', status: 'Active' },
    { name: 'Dependency Caps', desc: 'Limits concentration risk per supplier.', status: 'Active' },
    { name: 'Confidence Gate', desc: 'Requires >95% probability to reroute.', status: 'Strict' },
  ];
      ...
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        ...
        <div>
          <h2 className="text-3xl lg:text-5xl font-semibold tracking-tight text-ink mb-6">
            Ontology-Driven AI Reasoning.
          </h2>
          <p className="text-steel text-lg font-light leading-relaxed mb-8">
            Claude Sonnet 4.6 evaluates every deviation through the lens of 19 business rules. 
            It doesn't hallucinate logistics—it operates inside a strict mathematical ontology bounds, computing 
            delay costs and stockout penalties before ever suggesting an intervention.
          </p>
        ...
        >
          ...
          <div className="glass-card rounded-[20px] bg-white border border-black/10 overflow-hidden relative z-10 shadow-2xl">
            ...
            <div className="p-6 font-mono text-xs sm:text-sm text-steel leading-relaxed overflow-x-auto bg-[#FAFAFA]">
              ...
              <span className="ml-4 text-ink font-semibold">"supplier_target"</span>: <span className="text-accent">"TH-Logistics (Trust: 0.92)"</span><br/>
